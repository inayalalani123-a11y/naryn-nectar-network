...
type Entry = { en: string; ky: string };
...
export const dict: Dict = {
  ...
  "sym.webbing": { en: "Webbing or tunnels in comb (wax moth)", ky: "Балаарыда жип же туннелдер (мом көпөлүгү)" },
  ...
  "market.list": { en: "List your honey", ky: "Балыңды жарыяла" },
  "market.listTitle": { en: "List your honey on the marketplace", ky: "Балыңды базарга кош" },
  "market.listSub": { en: "Buyers will contact you directly using the details below.", ky: "Сатып алуучулар сени түз байланышат." },
  "market.listed": { en: "Your listing is live", ky: "Жарыяң чыкты" },
  "market.publish": { en: "Publish listing", ky: "Жарыялоо" },
  "market.f.name": { en: "Your name", ky: "Атың" },
  "market.f.brand": { en: "Brand / apiary name", ky: "Бренд / уюк аты" },
  "market.f.village": { en: "Village / town", ky: "Айыл / шаар" },
  "market.f.variety": { en: "Honey variety", ky: "Бал түрү" },
  "market.f.description": { en: "Short description", ky: "Кыскача баяндама" },
  "market.f.price": { en: "Price (USD per kg, e.g. 25)", ky: "Баасы (USD/кг, мис. 25)" },
  "market.f.email": { en: "Email", ky: "Email" },
...
export function formatPrice(price: string, lang: Lang): string {
  ...
  return `${som.toLocaleString("ky-KG")} сом / кг`;
}
